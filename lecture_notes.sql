...
SELECT first_name, last_name FROM employees WHERE first_name LIKE 'a%z%';

SELECT first_name FROM employees WHERE first_name LIKE 'a%z%';

SELECT DISTINCT first_name FROM employees WHERE first_name LIKE 'a%z%';

SELECT DISTINCT first_name, last_name FROM employees WHERE first_name LIKE 'a%z%';
...
SELECT * FROM employees WHERE emp_no BETWEEN 10001 AND 10010 OR emp_no BETWEEN 10201 AND 10210;
...
SELECT * FROM employees WHERE first_name LIKE 'Georgi' OR first_name LIKE 'Parto';
...
SELECT * FROM employees WHERE gender = 'F' AND emp_no < 10200;
...
SELECT * FROM employees WHERE emp_no < 10200 AND (gender = 'F' OR gender = 'M');
